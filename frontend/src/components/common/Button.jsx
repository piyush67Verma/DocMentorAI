...
const Button = ({
  ...
  const variantStyles = {
    primary:
      "bg-linear-to-r from-orange-500 to-orange-500 text-white shadow-lg shadow-orange-500/25 hover:from-orange-600 hover:to-orange-600 hover:shadow-xl hover:shadow-orange-500/30",
    secondary:
