        ...
        if (flashcardSets.length === 0) {
            return (
                <div className=" flex flex-col items-center justify-center py-14 px-6">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-linear-to-br from-orange-100 to-orange-100 mb-6">
                        <Brain className=" w-8 h-8 text-orange-600" strokeWidth={2} />
                    </div>
                ...
                <div className=" grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {flashcardSets.map((set) => (
                        <div
                            ...
                            className="group relative bg-white/80 backdrop-blur-xl border-2 border-slate-200 hover:border-orange-300 rounded-xl p-6 cursor-pointer transition-all duration-200 hover:shadow-lg hover:shadow-orange-50/10"
                        >
                            {/* Delete Button */}
                            <button
                            ...
                            <div className=" space-y-4">
                                <div className=" inline-flex items-center justify-center w-12 h-12 rounded-xl bg-linear-to-br from-orange-100 to-orange-100">
                                    <Brain className=" w-6 h-6 text-orange-600" strokeWidth={2} />
                                </div>
